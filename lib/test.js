...
module.exports = {
	...
	tests: [
		...
		function testAPICreateAPIKey(test) {
			...
			var self = this;
			var params = {"key":"35b60c12892dd4503cf3a8dbf22d3354","privileges":{"admin":1,"create_events":0,"edit_events":0,"delete_events":1,"run_events":0,"abort_events":0,"state_update":0},"active":"1","title":"test will delete","description":"dshfdwsfs","session_id":session_id};
		...
		function testAPIKeyUnauthorized(test) {
			// try to access an admin API with an API Key whose record has the admin bit set
