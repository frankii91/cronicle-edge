...
module.exports = Class.create({
	...
	api_login: async function (args, callback) {
		...
		// Local account controls take precedence over LDAP group authentication.
		// Check these before refreshing the user from LDAP, as that refresh replaces
		// the stored record and defaults newly provisioned accounts to active.
