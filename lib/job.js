		...
		async.series([
			...
			function (err) {
				...
				for (var idx = 0, len = servers.length; idx < len; idx++) {
					...
					// Preserve the requested identity for remote Unix workers, even when
					// this manager is running on Windows.  The worker decides whether to
					// apply these spawn options based on its own operating system.
